...
Generated by ./manage.py tom_setup on Aug. 14, 2024, 12:53 a.m.
...
SECRET_KEY = 'kntp9@dzbzv^-q#1*e(&amp;ojbom^@b_c-n)=%@xffvd-9dm7fbmo'
...
WSGI_APPLICATION = 'dev_tom.wsgi.application'
...
# Describe the columns to be included in the targetlist table.  Tuples must include
# the name of the Target attribute as well as the expected type of the entries
TARGETLIST_COLUMNS = [
    ('name', 'text'),
    ('RA', 'float'),
    ('Dec', 'float')
